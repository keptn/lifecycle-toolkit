...
// ConvertTo converts the src v1.KeptnApp to the hub version (v1beta1.KeptnApp)
...
// ConvertFrom converts from the hub version (v1beta1.KeptnApp) to this version (v1.KeptnApp)
