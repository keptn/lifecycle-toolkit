...
| `scheduler.scheduler.image.tag`                                                  | set image tag for scheduler <!---x-release-please-version-->   | `v0.6.0`                  |
...
| `certificateOperator.manager.image.tag`                | select tag for manager container  <!---x-release-please-version--> | `v0.6.0`                             |
...
| `lifecycleOperator.manager.image.tag`                                         | select tag for manager image  <!---x-release-please-version--> | `v0.6.0`                                       |
...
| `metricsOperator.manager.image.tag`                                         | select tag for manager image <!---x-release-please-version--> | `v0.6.0`                         |
