...
// ConvertTo converts the src v1alpha1.KeptnAppVersion to the hub version (v1beta1.KeptnAppVersion)
//
//nolint:gocyclo
...
// ConvertFrom converts from the hub version (v1beta1.KeptnAppVersion) to this version (v1alpha1.KeptnAppVersion)
//
//nolint:gocyclo
