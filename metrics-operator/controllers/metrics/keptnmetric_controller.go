...
func (r *KeptnMetricReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	value, rawValue, err := provider.GetMetricValue(ctx, *metric, *evaluationProvider)
	if err != nil {
...
func (r *KeptnMetricReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&metricsv1alpha2.KeptnMetric{}, builder.WithPredicates(predicate.GenerationChangedPredicate{})).
		Complete(r)
}

func (r *KeptnMetricReconciler) fetchProvider(ctx context.Context, namespacedMetric types.NamespacedName) (*metricsv1alpha2.KeptnMetricProvider, error) {
	provider := &metricsv1alpha2.KeptnMetricProvider{}
