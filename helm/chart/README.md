...
| `keptnScheduler.keptnScheduler.image.tag`                                        | set image tag for scheduler                                    | `202302241677231251`      |
...
| `kltCertManager.manager.image.tag`                | select tag for manager container                 | `202302241677231251`             |
...
| `klcControllerManager.manager.image.tag`                                         | select tag for manager image                      | `202302241677231251`                           |
...
| `metricsOperatorController.manager.image.tag`                                         | select tag for manager image                      | `202302241677231251`             |
