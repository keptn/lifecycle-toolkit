...
func TestKeptnAppReconciler_reconcile(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantErr: nil,
			event:   `Normal CreateAppVersion AppVersionCreated Create AppVersion created KeptnAppVersion / Namespace: default, Name: myapp-1.0.0-1, Version: 1.0.0`,
		},
		{
...
func TestKeptnAppReconciler_deprecateAppVersions(t *testing.T) {
	...
	event := <-eventChannel
	assert.Matches(t, event, `Normal CreateAppVersion AppVersionCreated Create AppVersion created KeptnAppVersion / Namespace: default, Name: myapp-1.0.0-1, Version: 1.0.0`)
	...
	event = <-eventChannel
	assert.Matches(t, event, `Normal CreateAppVersion AppVersionCreated Create AppVersion created KeptnAppVersion / Namespace: default, Name: myapp-1.0.0-2, Version: 1.0.0`)

	event = <-eventChannel
	assert.Matches(t, event, `Normal CreateAppVersion AppVersionDeprecated Create AppVersion deprecated KeptnAppVersions for KeptnAppVersion: myapp-1.0.0-2 / Namespace: default, Name: myapp, Version: 1.0.0`)
}
