...
import (
	...
	"github.com/keptn/lifecycle-toolkit/cert-manager/kubeobjects"
)
...
func (cs *Certs) validateServerCerts(now time.Time) bool {
	...
	isValid, err := kubeobjects.ValidateCertificateExpiration(cs.Data[ServerCert], renewalThreshold, now)
	if err != nil || !isValid {
