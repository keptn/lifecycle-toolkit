...
// GetMetricValue fetches the SLI values from prometheus provider
func (r *KeptnPrometheusProvider) GetMetricValue(ctx context.Context, metric v1alpha2.KeptnMetric, provider v1alpha2.KeptnMetricProvider) (string, []byte, error) {
