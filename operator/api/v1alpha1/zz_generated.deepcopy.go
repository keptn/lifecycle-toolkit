...
func (in *KeptnWorkloadSpec) DeepCopyInto(out *KeptnWorkloadSpec) {
	*out = *in
	if in.PreDeploymentTask != nil {
		in, out := &in.PreDeploymentTask, &out.PreDeploymentTask
		*out = new(EventSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.PostDeploymentTask != nil {
		in, out := &in.PostDeploymentTask, &out.PostDeploymentTask
		*out = new(EventSpec)
		(*in).DeepCopyInto(*out)
	}
	out.ResourceReference = in.ResourceReference
