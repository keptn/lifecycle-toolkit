...
{% include "./assets/observability.md_1.yaml" %}
...
{% include "./assets/observability.md_2.yaml" %}
...
{% include "./assets/observability.md_3.yaml" %}
...
{% include "./assets/observability.md_4.yaml" %}
...
{% include "./assets/observability.md_5.yaml" %}
...
{% include "./assets/observability.md_6.yaml" %}
...
{% include "./assets/observability.md_7.yaml" %}
...
{% include "./assets/observability.md_8.yaml" %}
