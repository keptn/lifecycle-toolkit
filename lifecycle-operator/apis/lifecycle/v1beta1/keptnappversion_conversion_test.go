...
func TestKeptnAppVersion_ConvertFrom(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Test that conversion from v1beta1 to v1 works",
			srcObj: &v1.KeptnAppVersion{
				...
				Status: v1.KeptnAppVersionStatus{
					...
					PromotionStatus:                v1common.StateFailed,
					...
					PromotionTaskStatus: []v1.ItemStatus{
						{
							DefinitionName: "def5",
							Name:           "name5",
							Status:         v1common.StateFailed,
						...
						{
							DefinitionName: "def52",
							Name:           "name52",
							Status:         v1common.StateSucceeded,
						},
					},
