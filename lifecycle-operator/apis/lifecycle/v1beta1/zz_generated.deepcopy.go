...
func (in *AutomountServiceAccountTokenSpec) DeepCopy() *AutomountServiceAccountTokenSpec {
	...
	out := new(AutomountServiceAccountTokenSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DeploymentTaskSpec) DeepCopyInto(out *DeploymentTaskSpec) {
	*out = *in
	...
	if in.PromotionTasks != nil {
		in, out := &in.PromotionTasks, &out.PromotionTasks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *KeptnAppContextList) DeepCopyInto(out *KeptnAppContextList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]KeptnAppContext, len(*in))
		for i := range *in {
...
func (in *KeptnAppContextSpec) DeepCopyInto(out *KeptnAppContextSpec) {
	*out = *in
	in.DeploymentTaskSpec.DeepCopyInto(&out.DeploymentTaskSpec)
	if in.Metadata != nil {
	...
	if in.SpanLinks != nil {
		in, out := &in.SpanLinks, &out.SpanLinks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *KeptnAppContextStatus) DeepCopy() *KeptnAppContextStatus {
	if in == nil {
		return nil
	}
	out := new(KeptnAppContextStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeptnAppCreationRequest) DeepCopy() *KeptnAppCreationRequest {
	...
	out := new(KeptnAppCreationRequest)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeptnAppCreationRequestList) DeepCopyInto(out *KeptnAppCreationRequestList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]KeptnAppCreationRequest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KeptnAppCreationRequestList) DeepCopy() *KeptnAppCreationRequestList {
	...
	out := new(KeptnAppCreationRequestList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeptnAppCreationRequestSpec) DeepCopy() *KeptnAppCreationRequestSpec {
	...
	out := new(KeptnAppCreationRequestSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeptnAppVersionSpec) DeepCopyInto(out *KeptnAppVersionSpec) {
	*out = *in
	in.KeptnAppContextSpec.DeepCopyInto(&out.KeptnAppContextSpec)
...
func (in *KeptnAppVersionStatus) DeepCopyInto(out *KeptnAppVersionStatus) {
	*out = *in
	...
	if in.PromotionTaskStatus != nil {
		in, out := &in.PromotionTaskStatus, &out.PromotionTaskStatus
		*out = make([]ItemStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *KeptnEvaluationDefinitionSpec) DeepCopyInto(out *KeptnEvaluationDefinitionSpec) {
	*out = *in
	...
	out.FailureConditions = in.FailureConditions
}
...
func (in *KeptnWorkloadSpec) DeepCopyInto(out *KeptnWorkloadSpec) {
	*out = *in
	...
	out.ObservabilityTimeout = in.ObservabilityTimeout
}
...
func (in *KeptnWorkloadVersionStatus) DeepCopyInto(out *KeptnWorkloadVersionStatus) {
	*out = *in
	...
	if in.AppContextMetadata != nil {
		in, out := &in.AppContextMetadata, &out.AppContextMetadata
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *Objective) DeepCopyInto(out *Objective) {
	*out = *in
	out.KeptnMetricRef = in.KeptnMetricRef
}
