...
func (a *WorkloadHandler) createWorkload(ctx context.Context, newWorkload *apilifecycle.KeptnWorkload) error {
...
func generateWorkload(ctx context.Context, pod *corev1.Pod, namespace string) *apilifecycle.KeptnWorkload {
	...
	return &apilifecycle.KeptnWorkload{
		...
		Spec: apilifecycle.KeptnWorkloadSpec{
			...
			Version:                   version,
			ResourceReference:         apilifecycle.ResourceReference{UID: ownerRef.UID, Kind: ownerRef.Kind, Name: ownerRef.Name},
