...
func TestKeptnWorkloadVersion(t *testing.T) {
	...
	retries := int32(5)
	task := workload.GenerateTask(v1alpha3.KeptnTaskDefinition{
	...
	require.Equal(t, v1alpha3.KeptnTaskSpec{
	...
	evaluation := workload.GenerateEvaluation(v1alpha3.KeptnEvaluationDefinition{
		ObjectMeta: v1.ObjectMeta{
			Name: "eval-def",
		},
	}, common.PostDeploymentCheckType)
	require.Equal(t, v1alpha3.KeptnEvaluationSpec{
		AppName:              workload.GetAppName(),
		WorkloadVersion:      workload.GetVersion(),
