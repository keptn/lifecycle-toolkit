...
| `scheduler.scheduler.image.tag`                                                  | set image tag for scheduler                                    | `202303071678183067`      |
...
| `lifecycleOperator.manager.image.tag`                                         | select tag for manager image                            | `202303071678183067`                           |
...
| `metricsOperator.manager.image.tag`                                         | select tag for manager image                      | `202303071678183067`             |
