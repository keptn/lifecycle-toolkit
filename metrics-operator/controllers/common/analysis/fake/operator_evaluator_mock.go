...
//			EvaluateFunc: func(val float64, criteria v1alpha3.Operator) analysis.OperatorResult {
...
func (mock *IOperatorEvaluatorMock) Evaluate(val float64, criteria v1alpha3.Operator) analysis.OperatorResult {
