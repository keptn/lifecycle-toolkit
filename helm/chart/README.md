...
| `lifecycleOperator.manager.env.functionRunnerImage`                           | specify image for js task runtime <!---x-release-please-version-->     | `ghcr.io/keptn/functions-runtime:v0.7.1`         |
| `lifecycleOperator.manager.env.pythonRunnerImage`                             | specify image for python task runtime <!---x-release-please-version--> | `docker.io/odubajdt/python-runtime:test12345678` |
