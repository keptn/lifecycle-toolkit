...
func (r *KeptnWorkloadReconciler) SetupWithManager(mgr ctrl.Manager) error {
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &klcv1alpha2.KeptnWorkload{}, "spec.app", func(rawObj client.Object) []string {
		workload := rawObj.(*klcv1alpha2.KeptnWorkload)
