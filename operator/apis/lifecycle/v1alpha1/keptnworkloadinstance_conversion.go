...
// ConvertTo converts the src v1alpha1.KeptnWorkloadVersion to the hub version (v1alpha3.KeptnWorkloadVersion)
...
// ConvertFrom converts from the hub version (v1alpha3.KeptnWorkloadVersion) to this version (v1alpha1.KeptnWorkloadVersion)
