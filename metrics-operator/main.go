...
func setupValidationWebhooks(mgr manager.Manager) {
	if err := (&metricsv1beta1.KeptnMetric{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "KeptnMetric")
		os.Exit(1)
	}
	if err := (&metricsv1beta1.AnalysisDefinition{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "AnalysisDefinition")
		os.Exit(1)
	}
	if err := (&metricsv1beta1.Analysis{}).SetupWebhookWithManager(mgr); err != nil {
