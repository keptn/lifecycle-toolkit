...
| `scheduler.scheduler.image.tag`                                                  | set image tag for scheduler                                    | `v0.6.0`                  |
...
| `certificateOperator.manager.image.tag`                | select tag for manager container                 | `v0.6.0`                             |
...
| `lifecycleOperator.manager.image.tag`                                         | select tag for manager image                            | `v0.6.0`                                       |
...
| `metricsOperator.manager.image.tag`                                         | select tag for manager image                      | `v0.6.0`                         |
