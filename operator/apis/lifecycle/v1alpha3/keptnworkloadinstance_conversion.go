...
// ConvertTo converts the src v1alpha3.KeptnWorkloadInstance to the hub version (v1alpha2.KeptnWorkloadInstance)
...
// ConvertFrom converts from the hub version (v1alpha2.KeptnWorkloadInstance) to this version (v1alpha3.KeptnWorkloadInstance)
