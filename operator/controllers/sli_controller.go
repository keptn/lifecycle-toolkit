...
//+kubebuilder:rbac:groups=lifecycle.keptn.sh,resources=sli,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=lifecycle.keptn.sh,resources=sli/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=lifecycle.keptn.sh,resources=sli/finalizers,verbs=update
