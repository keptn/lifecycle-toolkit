...
type IEvaluationHandler interface {
	ReconcileEvaluations(ctx context.Context, phaseCtx context.Context, reconcileObject client.Object, evaluationCreateAttributes CreateEvaluationAttributes) ([]lifecycle.ItemStatus, apicommon.StatusSummary, error)
}
...
func (r Handler) ReconcileEvaluations(ctx context.Context, phaseCtx context.Context, reconcileObject client.Object, evaluationCreateAttributes CreateEvaluationAttributes) ([]lifecycle.ItemStatus, apicommon.StatusSummary, error) {
	...
	var newStatus []lifecycle.ItemStatus
...
func (r Handler) emitEvaluationFailureEvents(evaluation *lifecycle.KeptnEvaluation, spanTrace trace.Span, piWrapper *interfaces.PhaseItemWrapper) {
...
func (r Handler) setupEvaluations(evaluationCreateAttributes CreateEvaluationAttributes, piWrapper *interfaces.PhaseItemWrapper) ([]string, []lifecycle.ItemStatus) {
	var evaluations []string
	var statuses []lifecycle.ItemStatus
...
func (r Handler) handleEvaluationNotExists(ctx context.Context, phaseCtx context.Context, evaluationCreateAttributes CreateEvaluationAttributes, evaluationName string, piWrapper *interfaces.PhaseItemWrapper, reconcileObject client.Object, evaluation *lifecycle.KeptnEvaluation, evaluationStatus *lifecycle.ItemStatus) error {
...
func (r Handler) handleEvaluationExists(phaseCtx context.Context, piWrapper *interfaces.PhaseItemWrapper, evaluation *lifecycle.KeptnEvaluation, evaluationStatus *lifecycle.ItemStatus) {
