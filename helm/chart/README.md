...
| `keptnScheduler.keptnScheduler.image.tag`                                        | set image tag for scheduler                                    | `202302221677049653`      |
...
| `kltCertManager.manager.image.tag`                | select tag for manager container                 | `202302221677049653`             |
...
| `klcControllerManagerMetricsService.ports[2].name`       | TODO  TODO  TODO                                          | `custom-metrics` |
| `klcControllerManagerMetricsService.ports[2].port`       | TODO  TODO  TODO                                          | `443`            |
| `klcControllerManagerMetricsService.ports[2].targetPort` | TODO  TODO  TODO                                          | `custom-metrics` |
| `klcControllerManagerMetricsService.ports[3].name`       | TODO  TODO  TODO                                          | `keptn-metrics`  |
| `klcControllerManagerMetricsService.ports[3].port`       | TODO  TODO  TODO                                          | `9999`           |
| `klcControllerManagerMetricsService.ports[3].protocol`   | TODO  TODO  TODO                                          | `TCP`            |
| `klcControllerManagerMetricsService.ports[3].targetPort` | TODO  TODO  TODO                                          | `keptn-metrics`  |
...
| `klcControllerManager.manager.image.tag`                                         | select tag for manager image                      | `202302221677049653`                           |
