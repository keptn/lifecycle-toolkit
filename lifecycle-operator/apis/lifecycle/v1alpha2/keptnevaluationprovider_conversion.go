...
// ConvertTo converts the src v1alpha2.KeptnEvaluationProvider to the hub version (v1beta1.KeptnEvaluationProvider)
func (src *KeptnEvaluationProvider) ConvertTo(dstRaw conversion.Hub) error {
	dst, ok := dstRaw.(*v1beta1.KeptnEvaluationProvider)
...
// ConvertFrom converts from the hub version (v1beta1.KeptnEvaluationProvider) to this version (v1alpha2.KeptnEvaluationProvider)
func (dst *KeptnEvaluationProvider) ConvertFrom(srcRaw conversion.Hub) error {
	src, ok := srcRaw.(*v1beta1.KeptnEvaluationProvider)
