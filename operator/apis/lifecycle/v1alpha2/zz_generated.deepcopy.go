...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeptnMetricRef) DeepCopyInto(out *KeptnMetricRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeptnMetricRef.
func (in *KeptnMetricRef) DeepCopy() *KeptnMetricRef {
	if in == nil {
		return nil
	}
	out := new(KeptnMetricRef)
	in.DeepCopyInto(out)
	return out
}
