...
We need to create the `KeptnApp` in order to define all workloads and checks associated with the application.
...
However, we encourage you to create this custom `KeptnApp` CRD.
