...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AnalysisValue) DeepCopyInto(out *AnalysisValue) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnalysisValue.
func (in *AnalysisValue) DeepCopy() *AnalysisValue {
	if in == nil {
		return nil
	}
	out := new(AnalysisValue)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AnalysisValue) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AnalysisValueList) DeepCopyInto(out *AnalysisValueList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]AnalysisValue, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnalysisValueList.
func (in *AnalysisValueList) DeepCopy() *AnalysisValueList {
	if in == nil {
		return nil
	}
	out := new(AnalysisValueList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AnalysisValueList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AnalysisValueSpec) DeepCopyInto(out *AnalysisValueSpec) {
	*out = *in
	out.AnalysisTemplate = in.AnalysisTemplate
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnalysisValueSpec.
func (in *AnalysisValueSpec) DeepCopy() *AnalysisValueSpec {
	if in == nil {
		return nil
	}
	out := new(AnalysisValueSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AnalysisValueStatus) DeepCopyInto(out *AnalysisValueStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnalysisValueStatus.
func (in *AnalysisValueStatus) DeepCopy() *AnalysisValueStatus {
	if in == nil {
		return nil
	}
	out := new(AnalysisValueStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TimeframeDefinition) DeepCopyInto(out *TimeframeDefinition) {
	*out = *in
	in.From.DeepCopyInto(&out.From)
	in.To.DeepCopyInto(&out.To)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TimeframeDefinition.
func (in *TimeframeDefinition) DeepCopy() *TimeframeDefinition {
	if in == nil {
		return nil
	}
	out := new(TimeframeDefinition)
	in.DeepCopyInto(out)
	return out
}
