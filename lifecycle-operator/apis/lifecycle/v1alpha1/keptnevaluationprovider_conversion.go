...
// ConvertTo converts the src v1alpha1.KeptnEvaluationProvider to the hub version (v1beta1.KeptnEvaluationProvider)
...
// ConvertFrom converts from the hub version (v1beta1.KeptnEvaluationProvider) to this version (v1alpha1.KeptnEvaluationProvider)
