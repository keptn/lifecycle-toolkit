...
| `scheduler.scheduler.image.tag`                                                  | set image tag for scheduler <!---x-release-please-start-version--> | `v0.7.0`                        |
...
| `certificateOperator.manager.image.tag`                | select tag for manager container  <!---x-release-please-start-version-->    | `v0.7.0`                                   |
...
| `lifecycleOperator.manager.image.tag`                                         | select tag for manager image  <!---x-release-please-start-version--> | `v0.7.0`                                       |
...
| `metricsOperator.manager.image.tag`                                         | select tag for manager image <!---x-release-please-start-version--> | `v0.7.0`                               |
